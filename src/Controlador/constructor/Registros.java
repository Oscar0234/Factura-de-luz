...
public class Registros {
    ...
    public Registros(String Nombre, String Direccion, String Nºmedidor, int NIS, int Diasfacturados, 
            String Mesfacturado, String Fechaemicion, String Fechavencimiento, int kWh, double EnergiaC$, 
            double Alumbradopublico, double Comercializacion, double Subsidio, double Subsidiocomercial, 
            double INE, String Periodoinicio, String Periodofinal, double Totalpagar, double Totaldeuda) {
